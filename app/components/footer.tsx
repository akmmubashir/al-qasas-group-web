      ...
      <div className="relative p-[80px_80px] max-xl:p-[60px_40px] max-lg:p-[60px_20px] max-md:p-[40px_20px]">
          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-7 max-lg:col-span-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[#0D72B6] text-sm font-semibold tracking-widest uppercase">
                  Newsletter
                </span>
              </div>
        ...
        <div className="grid grid-cols-12 gap-12 max-lg:gap-8 mb-12">
          ...
          <div className="col-span-4 max-lg:col-span-12">
            ...
            {/* Social Media */}
            <div>
              <h4 className="text-white text-[15px] font-semibold mb-4 tracking-wide">
                Connect With Us
              </h4>
              <div className="flex gap-3">
                ...
                >
                  <svg
                    className="w-5 h-5 text-slate-400 group-hover:text-[#0D72B6] transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <li className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-slate-300 hover:text-[#0D72B6] transition-colors text-[14px] font-light"
                  >
                    info@alqasas.com
                  </a>
                </div>
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-slate-400 text-[13px] font-light">
                © {new Date().getFullYear()} Al-Qasas Trading & Contracting. All
                rights reserved
              </p>
            </div>
            <div className="flex items-center gap-6">
              <Link
                href="#"
                className="text-slate-400 hover:text-[#0D72B6] transition-colors text-[13px] font-light"
              >
                Terms & Conditions
              </Link>
