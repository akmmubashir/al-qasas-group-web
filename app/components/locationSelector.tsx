...
const LocationSelector = () => {
    ...
    const { selectedLocation, setSelectedLocation, initializeLocation } = useLocationStore();
        ...
        <div className='flex gap-2 bg-blue-100 p-2 max-md:p-1'>
            {locationList.map(location => (
                <button
                    ...
                    className={`cursor-pointer flex items-center p-1 transition-all border-b-2 ${selectedLocation.code === location.code
