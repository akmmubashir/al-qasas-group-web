  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="cursor-pointer uppercase text-[16px] max-md:text-[14px] p-[10px_20px] max-md:p-[8px_12px] rounded-md bg-[#0D72B6] hover:bg-white text-white hover:text-black hover:scale-95 transition-all duration-300 font-medium shadow-2xl">
          Enquire
        </button>
      </div>
    </div>
