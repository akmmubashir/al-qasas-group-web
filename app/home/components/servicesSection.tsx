        ...
        <div className="text-center mb-16 max-lg:mb-12">
          <div ref={titleRef}>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0D72B6]/10 border border-[#0D72B6]/20 rounded-full mb-6">
              ...
              <span className="text-[#0D72B6] text-sm font-bold tracking-wider uppercase">What We Offer</span>
            </div>
          ...
          >
            Comprehensive solutions tailored to meet the diverse needs of businesses across Qatar and Saudi Arabia
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-full bg-white rounded-3xl p-8 max-lg:p-6 border-2 border-gray-100 hover:border-[#0D72B6]/30 shadow-sm hover:shadow-2xl hover:shadow-[#0D72B6]/10 transition-all duration-500 overflow-hidden group-hover:-translate-y-2">
                ...
                <div className={`absolute top-0 right-0 w-32 h-32 bg-linear-to-br ${service.gradient} opacity-0 group-hover:opacity-10 rounded-full blur-2xl transition-opacity duration-500`} />

                {/* Icon Container */}
                <div className={`relative w-16 h-16 bg-linear-to-br ${service.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                ...
                {/* CTA Link */}
                <div
                  className="inline-flex items-center gap-2 text-[#0D72B6] font-bold text-sm group-hover:gap-3 transition-all duration-300"
                >
                ...
                <div className="absolute bottom-0 right-0 w-24 h-24 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className={`absolute bottom-0 right-0 w-full h-full bg-linear-to-tl ${service.gradient} opacity-5 rounded-tl-[100px]`} />
                </div>
              </div>
            </Link>
          ))}
