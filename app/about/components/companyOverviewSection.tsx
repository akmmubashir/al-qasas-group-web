      ...
      <div className="relative z-10 p-20 max-xl:p-[60px_40px] max-lg:p-[60px_20px] max-md:p-[40px_18px]">
        ...
        <div className="grid grid-cols-12 gap-10 max-xl:gap-8 max-lg:grid-cols-1 mb-16">
          <div
            ...
            ref={introRef}
          >
            <div className="bg-linear-to-br from-slate-50 to-white border border-slate-200/60 p-8 shadow-lg hover:shadow-xl transition-all duration-500 backdrop-blur-sm">
              ...
              <div className="mt-8 grid grid-cols-2 max-sm:grid-cols-1 gap-4 text-left">
                <div className="group flex items-start gap-4 p-4 transition-all duration-300 hover:bg-cyan-50/50">
                ...
                <div className="group flex items-start gap-4 p-4 transition-all duration-300 hover:bg-blue-50/50">
            ...
            >
              {pillars.map((pillar) => (
                <div
                  key={pillar.id}
                  className="pillar-card group relative overflow-hidden border border-slate-200/60 bg-linear-to-br from-white via-slate-50 to-slate-100 p-6 transition-all duration-500 hover:border-cyan-400/80 hover:shadow-xl hover:-translate-y-2 cursor-pointer"
                >
          ...
          <div className="col-span-5 max-lg:col-span-12" ref={imageRef}>
            <div className="relative h-full overflow-hidden border border-slate-200/60 bg-white shadow-xl hover:shadow-2xl transition-all duration-500 group">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 grid grid-cols-2 gap-3 text-left">
                <div className="border border-white/20 bg-white/90 backdrop-blur-md p-4 shadow-lg transform group-hover:-translate-y-1 transition-all duration-500">
                ...
                <div className="border border-white/20 bg-white/90 backdrop-blur-md p-4 shadow-lg transform group-hover:-translate-y-1 transition-all duration-500 delay-75">
                  <p className="text-xs uppercase tracking-widest font-semibold text-slate-500 mb-2">
                    Field footprint
                  </p>
        ...
        >
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="stat-card group relative overflow-hidden border border-slate-200/60 bg-linear-to-br from-slate-50 via-white to-slate-50 p-7 transition-all duration-500 hover:border-cyan-400/80 hover:shadow-lg hover:-translate-y-1 cursor-pointer"
            >
        ...
        <div
          ref={rhythmRef}
          className="border border-slate-200/60 bg-linear-to-br from-slate-50 via-white to-slate-50 p-10 max-lg:p-6 shadow-lg hover:shadow-xl transition-all duration-500"
        >
          ...
          <div className="grid grid-cols-3 max-lg:grid-cols-1 gap-6">
            {deliveryRhythm.map((item, index) => (
              <div
                key={item.id}
                className="rhythm-card group relative overflow-hidden border border-slate-200/60 bg-white p-6 transition-all duration-500 hover:border-cyan-400/80 hover:shadow-lg hover:-translate-y-1 cursor-pointer"
              >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-linear-to-br from-cyan-50 to-blue-50 transition-all duration-500"></div>
