    ...
    <section ref={sectionRef} className="relative bg-white overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="grid grid-cols-12 items-start">
          <div className="p-20 max-xl:p-[60px_40px] max-lg:p-[60px_20px] max-md:p-[40px_20px] col-span-6 max-lg:col-span-full max-lg:order-2">
            <div className="mb-12" ref={titleRef}>
              {/* <SubHeading title="Send a message" /> */}
              <Heading title1="Tell us about your" title2="project" />
              <p className="text-[18px] max-xl:text-[16px] max-lg:text-[14px] text-slate-600 max-w-2xl leading-relaxed">
            ...
            <form
              ...
              className="bg-white border border-slate-200 shadow-xl p-8 max-md:p-6 space-y-4"
            >
          ...
          <div
            ref={asideRef}
            className="col-span-6 max-lg:col-span-full shadow-2xl overflow-hidden h-full"
          >
            <Image
